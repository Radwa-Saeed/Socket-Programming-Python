...
#inserting data to codeloop database in wampserver
    ...
    def insert_data(self):
        try:
            # CONNECTING TO DB CALLED Socket
            mydb = mc.connect(
            ...
            # CREATING TABLE IN DB IF NOT EXIST 
            mycursor.execute("CREATE TABLE IF NOT EXISTS USERS(Email VARCHAR (255)  NOT NULL PRIMARY KEY,password VARCHAR(255) UNIQUE NOT NULL)")
